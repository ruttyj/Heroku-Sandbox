...
const requireRegisteredInRoomHandler                      = (next=null) => new RequireRegistered(new RequireRoomConnection(next));
...
socketRegistry.public('join_room',                          new RequireRegistered(new JoinRoom()));
socketRegistry.public('leave_room',                         requireRegisteredInRoomHandler(
                                                              new LeaveRoom(
...
socketRegistry.public('message',                            requireRegisteredInRoomHandler(new SendMessage()));
socketRegistry.public('typing',                             requireRegisteredInRoomHandler(new NotifyIsTyping()));
